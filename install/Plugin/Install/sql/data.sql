...
(1,    'ru',           NULL,            0,          'main.php',     0,            'Menu1',          1,           '[[[[time]]]]',   '[[[[time]]]]',  'default',  'menu1'),
(2,    'ru',           NULL,            0,          'main.php',     1,            'Menu2',          1,           '[[[[time]]]]',   '[[[[time]]]]',  'default',  'menu2'),
(3,    'ru',           NULL,            0,          'main.php',     2,            'Menu3',          1,           '[[[[time]]]]',   '[[[[time]]]]',  'default',  'menu3'),
(4,    'ru',           '',          1,          'home.php',     0,            'Главная',           1,           '[[[[time]]]]',   '[[[[time]]]]',  'default',  NULL),
(5,    'ru',           'lorem-ipsum',  1,          NULL,     1,            'Ещё одна',    1,           '[[[[time]]]]',   '[[[[time]]]]',  'default',  NULL),
(6,    'ru',           'page1',         2,          NULL,     0,            'Подстраница 1',          1,           '[[[[time]]]]',   '[[[[time]]]]',  'default',  NULL),
(7,    'ru',           'page2',         2,          NULL,     1,            'Подстраница 2',          1,           '[[[[time]]]]',   '[[[[time]]]]',  'default',  NULL),
(8,    'ru',           'example1',      3,          NULL,     0,            'Example 1',      1,           '[[[[time]]]]',   '[[[[time]]]]',  'default',  NULL),
(9,    'ru',           'example2',      3,          NULL,     1,            'Example 2',      1,           '[[[[time]]]]',   '[[[[time]]]]',  'default',  NULL);
...
(1, 1, 50, 0, 'main', 1, 0, 'Heading', 'default', '{"title":"Главная страница","level":"1"}', [[[[timestamp]]]], [[[[timestamp]]]]),
...
(3, 2, 50, 0, 'main', 1, 0, 'Heading', 'default', '{"title":"Содержимое страницы","level":"1"}', [[[[timestamp]]]], [[[[timestamp]]]]),
...
('Admin', 'failedLogins', '[]'),
('Config', 'Config.ru.websiteTitle', '""'),
('Config', 'Config.ru.websiteEmail', '"example@example.com"'),
