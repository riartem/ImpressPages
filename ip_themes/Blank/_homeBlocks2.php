...
<?php
        ...
        case 3:
?>
            <div class="col_12 col_lg_4 col_lg_4 z3">
                <?php echo $this->generateBlock('home'.++$count)->asStatic()->exampleContent($exampleContent); ?>
            </div>
            <div class="col_12 col_lg_4 col_lg_4 z2">
                <?php echo $this->generateBlock('home'.++$count)->asStatic()->exampleContent($exampleContent); ?>
            </div>
            <div class="col_12 col_lg_4 col_lg_4 z1">
                <?php echo $this->generateBlock('home'.++$count)->asStatic()->exampleContent($exampleContent); ?>
            </div>
<?php
            break;
...
?>
            ...
            <div class="clear hidden_md hidden_lg z2"></div>
